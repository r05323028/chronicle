# recorder-etl-service-boundaries Specification

## Purpose

Define logical Recorder, evidence, ETL, and canonical-store boundaries while documenting the current co-located filesystem deployment without making co-location a correctness requirement.
