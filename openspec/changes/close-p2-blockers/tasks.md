...
- [ ] 5.5 Replace duplicated P1/P2 runners with unified profile/executor orchestration, fingerprinted `acceptance/<profile>/<fingerprint>/<run-id>` evidence, scenario coverage, environment compatibility, manifest integrity, and P2→P1-only reuse.
