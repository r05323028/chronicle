...
- Architecture/specification documentation only: `docs/architecture/overview.md`, `docs/architecture/crate-boundaries.md`, `AGENTS.md`, and the new capability spec.
...
- Compare the documented crate graph (`docs/architecture/overview.md` Boundaries, `docs/architecture/crate-boundaries.md`) against actual `cargo metadata` output.
...
- Verify `AGENTS.md`, `docs/architecture/overview.md`, and `docs/architecture/crate-boundaries.md` agree on the durable architecture rules.
