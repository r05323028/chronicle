...
- [ ] F2.4 `[chronicle-storage, chronicle-application tests]` Consolidate mutable-v1 atomic publication, inspect integrity/safe output/partial replayability, WAL-absent behavior, and shared JSON failure tests; depends on Gate D.
