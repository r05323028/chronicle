...
- [ ] F2.6 `[chronicle-application tests]` Rootless fixture v1 -> WAL group commit/recovery -> reconstruction/loss windows -> HTTP -> deterministic session -> inspect -> authorized mixed replay -> verification; label as fixture, not eBPF; depends on F2.1-F2.5.
