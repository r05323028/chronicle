...
function theme(name, type, p) {
  return {
    ...
    tokenColors: [
      ...
      { scope: ['keyword', 'storage', 'storage.type'], settings: { foreground: p.purple } },
      { scope: ['string', 'constant.character'], settings: { foreground: p.green } },
      { scope: ['constant.numeric', 'constant.language'], settings: { foreground: p.orange } },
      { scope: ['entity.name.function', 'support.function'], settings: { foreground: p.blue } },
      { scope: ['entity.name.type', 'support.type'], settings: { foreground: p.cyan } },
      { scope: ['entity.name.tag'], settings: { foreground: p.red } },
      { scope: ['keyword.operator', 'punctuation'], settings: { foreground: p.cyan } },
      { scope: ['variable', 'entity.name.variable'], settings: { foreground: p.fg } },
...
export default defineEcConfig({
  themes: [theme('tokyo-night', 'dark', palettes.night), theme('tokyo-night-day', 'light', palettes.day)],
